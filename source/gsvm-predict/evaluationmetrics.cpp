...
/* Getters */
double EvaluationMetrics::getAcc(){return acc;}
double EvaluationMetrics::getAP(){return ap;}
double EvaluationMetrics::getPrec(){return prec;}
double EvaluationMetrics::getRecall(){return recall;}
